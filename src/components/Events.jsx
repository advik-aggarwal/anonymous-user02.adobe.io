...
<h1 data-aos="fade-up" data-aos-duration="750" className={"text-center drop-shadow-[0_0px_35px_#007bc4] text-[#007bc4] mb-14 mt-32 text-4xl heading"}>
THE PILLARS OF DIGITAL INDIA</h1> 
...
<Link to={Event.href}  className="carousel-item" style={{backgroundImage : `url(${Event.imageLink})`, backgroundSize : "cover", backgroundPosition : "left center "}}>
        <div className="carousel-box " >
          ...
          <div className="num text-[10px] akira text-white"> {Event.Name} <br />#{Event.id}</div>
